...
Install a specific version by specifying it as a parameter; for example, to obtain v1.2.2-1:
```
npm install github:smart-on-fhir/health-cards-dev-tools#v1.2.2-1
```
