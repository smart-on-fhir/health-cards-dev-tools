...
This project provides tools to help implementers of the [SMART Health Card Framework](https://smarthealth.cards/) validate the artifacts they produce. The package's version number, currently `1.2.1-3`, matches the [specification version](https://smarthealth.cards/changelog/) the tool validates.
...
Install a specific version by specifying it as a parameter; for example, to obtain v1.2.1-3:
```
npm install github:smart-on-fhir/health-cards-dev-tools#v1.2.1-3
```
