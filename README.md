...
Install a specific version by specifying it as a parameter; for example, to obtain v1.3.0-0:
```
npm install github:smart-on-fhir/health-cards-dev-tools#v1.3.0-0
```
